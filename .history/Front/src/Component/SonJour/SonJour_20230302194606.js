...
import {handleSonJour,handleAdd} from "../../Services/SpotifyApi";
...
const SonJour = () => {
    ...
    const AddToPlaylist = (data) =>{
      //  handleAdd("Playlist",data).catch(err=>console.log(err));
      console.log(data);
    }
...
{valid === true ?
    <Row className={"mx-2 row row-cols-4" } >
                ...
                <Card >
                    ...
                    <button type="submit" onClick={() => { AddToPlaylist(Playlist.album.id) }}>Add to Playlist</button>
                </Card>
