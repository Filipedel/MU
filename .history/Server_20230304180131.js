...
server.get("/home", (req, res) => {
  ...
  res.cookie("ConnexionStatue", "True", {
      sameSite: "none",
      secure: true,
    }).redirect("/");
});
...
// get id of song and add it to Playlist or Queue depenending of type var
...
//sending Playlist of user
server.get("/add/"+AddType, (req, res) => {
...
server.get("/playlist", (req, res) => {
  spotifytoken.getUserPlaylists().then(
    function (data) {
      console.log("Retrieved playlists", data.body);
      res.send({
        Dataplaylist: data.body,
